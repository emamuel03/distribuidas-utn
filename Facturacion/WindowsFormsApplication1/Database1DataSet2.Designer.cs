...
namespace WindowsFormsApplication1.Database1DataSet2TableAdapters {
    ...
    public partial class categoriaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[categoria] ([nombre]) VALUES (@nombre);\r\nSELECT id_categoria, " +
                "nombre FROM categoria WHERE (id_categoria = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[categoria] SET [nombre] = @nombre WHERE (([id_categoria] = @Original_id_categoria) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)));
SELECT id_categoria, nombre FROM categoria WHERE (id_categoria = @id_categoria)";
        ...
        public virtual int Fill(Database1DataSet2.categoriaDataTable dataTable) {
        ...
        public virtual Database1DataSet2.categoriaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.categoriaDataTable dataTable = new Database1DataSet2.categoriaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.categoriaDataTable dataTable) {
